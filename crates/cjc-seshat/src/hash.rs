//! Deterministic content-addressing for Seshat traces and reports.
//!
...
//! - **No dependencies.** A ~15-line implementation; Seshat does not take on
...
pub struct SeshatHasher {
    state: u64,
}

impl Default for SeshatHasher {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    fn deterministic_same_input_same_hash() {
        let mut a = SeshatHasher::new();
        let mut b = SeshatHasher::new();
