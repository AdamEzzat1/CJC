...
/// A hand-tuned linear cost model over `CanaFeatures`.
///
...
impl LinearCostModel {
    /// Construct the default Phase 2 model. No configuration knobs are
    /// exposed at this layer; the trained-model future replaces this with
    /// a tunable predictor.
    ...
    fn pass_coefficients(pass_name: &str) -> Option<PassCoefficients> {
        match pass_name {
