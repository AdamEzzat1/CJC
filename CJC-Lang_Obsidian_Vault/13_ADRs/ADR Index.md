...
| [[ADR-0024 Tier-0 Slot Resolution]] | `VarLocal` variant + `HirToMir` slot tracker + executor pattern coverage | Accepted | 2026-05-20 | Stages 1+2 shipped; foundation for Stage 3 frame fast-path (expected 3-5× on `lookup`) |
